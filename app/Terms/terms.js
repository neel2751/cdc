...
const Terms = () => {
  return (
    <div class="styles-content-ea4771 t-previewContent">
        ...
        <article>
          <div data-custom-class="body">
            <div align="center" style={{ textAlign: "left" }}>
              ...
              <div class="MsoNormal" style={{ lineHeight: "1.1" }}>
                <br />
              </div>
              <div class="MsoNormal" style={{ lineHeight: "115%" }}>
                <br />
              </div>
              <div class="MsoNormal" style={{ lineHeight: "115%" }}>
                <br />
            ...
            <div align="center" style={{ textAlign: "left" }}>
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: "rgb(0, 58, 250)" }}>
                    <bdt class="question">https://cdc.construction</bdt>
                  </span>
                  (the
                  <bdt class="block-component"></bdt>'<strong>Site</strong>'
                  ...
                  legal terms (the
                  <bdt class="block-component"></bdt>'
                  <strong>Legal Terms</strong>'<bdt class="else-block"></bdt>)
                  (collectively, the
              ...
              >
                <bdt class="question">
                  We handle renovations, loft &amp; basement conversions,
                  extensions, design &amp; build, architectural design, and
                  commercial fit-outs. From concept to completion, we build your
                  vision.
                </bdt>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  <bdt class="block-component"></bdt>
                  phone at
                  <bdt class="question">020-8004-3327</bdt>, email at
                  <bdt class="question">info@cdc.construction</bdt>
                  <bdt class="block-component"></bdt>,
                  <bdt class="statement-end-if-in-editor"></bdt>
                  or by mail to
                  <bdt class="question">595a Cranbrook Road</bdt>
                  <bdt class="block-component"></bdt>,
                  <bdt class="question">illford</bdt>
                  <bdt class="block-component"></bdt>,
                  <bdt class="question">London</bdt>
                  <bdt class="statement-end-if-in-editor"></bdt>
                  <bdt class="block-component"></bdt>
                  <bdt class="question">IG2 6JZ</bdt>
                  <bdt class="statement-end-if-in-editor"></bdt>
                  <bdt class="block-component">,&nbsp;</bdt>
              ...
              >
                ...
                >
                  ...
                  <bdt class="block-component"></bdt>'<strong>y</strong>
                  <strong>ou</strong>'<bdt class="else-block"></bdt>
                  ), and
                  <bdt class="question">
                    Creative Design &amp; Construction LIMITED
                  </bdt>
              ...
              >
                ...
                >
                  ...
                  <bdt class="block-component"></bdt>
                  from time to time
                  <bdt class="else-block"></bdt>. We will alert you about any
            ...
            <div align="center" style={{ textAlign: "left" }}>
              ...
              <div class="MsoNormal" style={{ lineHeight: "1.5" }}>
                ...
                <a data-custom-class="link" href="#userreps">
                  <span style={{ color: "rbg(0, 58, 250)", fontSize: "15px" }}>
                    <span data-custom-class="body_text">
            ...
            <div align="center" style={{ textAlign: "left" }}>
              ...
              >
                ...
                >
                  ...
                  <bdt class="question">info@cdc.construction</bdt>. If we ever
            ...
            <div align="center" style={{ textAlign: "left" }}>
              ...
              >
                ...
                <strong>
                  <span style={{ lineHeight: "115%", fontSize: "19px" }}>
                    <strong>
                      <span style={{ lineHeight: "115%", fontSize: "19px" }}>
                        <strong>
                          <span
                ...
                >
                  ...
                  <div class="MsoNormal" style={{ lineHeight: "17.25px" }}>
                    ...
                    >
                      ...
                      >
                        ...
                        <bdt class="block-component"></bdt>
                        organise
                        <bdt class="else-block"></bdt>a campaign encouraging
                  ...
                  >
                    ...
                    >
                      ...
                      <bdt class="block-component"></bdt>
                      Site
                      <bdt class="block-component"></bdt>) links to other
                      websites (<bdt class="block-component"></bdt>
                      'Third-Party Websites'
                      <bdt class="else-block"></bdt>) as well as articles,
                      ...
                      third parties (<bdt class="block-component"></bdt>
                      'Third-Party Content'
                      <bdt class="else-block"></bdt>
                      ). Such{" "}
                  ...
                  >
                    ...
                    >
                      ...
                      <strong>
                        ...
                        <span style={{ color: "rgb(0, 58, 250)" }}>
                          <bdt
                            ...
                            data-type="question"
                          >
                            www.cdc.construction/privacy-policy
                          </bdt>
                        </span>
                      </strong>
                      ...
                      <bdt class="question">United Kingdom</bdt>
                      <bdt class="block-component"></bdt>
                      <bdt class="block-component"></bdt>. If you access the
                      ...
                      <bdt class="block-component"></bdt>, then through your
                      ...
                      <bdt class="block-component"></bdt>, and you expressly
                  ...
                  >
                    ...
                    for the International Sales of Goods is expressly excluded.
                    ...
                    <bdt class="question">London</bdt>, which means that you may
                    make a claim to defend your consumer protection rights in
                    regards to these Legal Terms in
                    <bdt class="block-component">
                      the
                      <bdt class="question">United Kingdom</bdt>
                      <bdt class="else-block"></bdt>, or in the EU country in
                      which you reside.
                      <bdt class="else-block"></bdt>
                    </bdt>
                  </div>
                  ...
                  >
                    <span style={{ fontSize: "15px" }}>
                      ...
                      Terms (each a<bdt class="block-component"></bdt>
                      'Dispute' and collectively, the 'Disputes'
                      <bdt class="else-block"></bdt>) brought by either you or
                      us (individually, a<bdt class="block-component"></bdt>
                  ...
                  >
                    <span style={{ fontSize: "19px" }}>
                      <strong>22. SMS TEXT MESSAGING</strong>
                    </span>
                  </div>
                  <div
                    class="MsoNormal"
                  ...
                  >
                    <strong>
                      <span style={{ fontSize: "15px" }}>Opting Out</span>
                    </strong>
                  </div>
                  <div
                    class="MsoNormal"
                  ...
                  >
                    <span style={{ fontSize: "15px" }}>
                      <bdt class="block-component"></bdt>
                      <bdt class="question">
                        If at any time you wish to stop receiving SMS message
                        from us, please call us at 020-8004-3327 or Email us to
                        STOP at info@cdc.construction
                      </bdt>
                      <bdt class="statement-end-if-in-editor"></bdt>
                    </span>
                  </div>
                  ...
                  >
                    <span style={{ fontSize: "15px" }}>
                      ...
                      <bdt class="block-component"></bdt>
                      or call at
                      <bdt class="question">020-8004-3327</bdt>
                      <bdt class="statement-end-if-in-editor"></bdt>
                      .<br />
                    </span>
                  </div>
