                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="py-3 px-4 block w-full border border-gray-800 rounded-lg text-sm font-medium focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                          required
                          aria-describedby="email-error"
                        />
                        <div
                          className={`absolute inset-y-0 end-0 items-center pointer-events-none pe-3 ${
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          value={data.password}
                          onChange={handleChange}
                          className="py-3 px-4 block w-full border border-gray-800 font-medium rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                          required
