...
//           // object id convert  to string and all other data to send
//           return {
...
//   session: {
//     strategy: "jwt", // use the credentials strategy
//   },
//   jwt: {
//     secret: process.env.JWT_SECRET, // use the secret key from the environment variable
//   },
//   callbacks: {
//     async jwt({ token, user }) {
...
//       }
//       return token; // return the token with the user's id
//     },
//     async session({ session, token }) {
//       // this function is called after the user is authenticated
...
//       }
//       return session; // return the session with the user's id
//     },
//   }, // end of callbacks
//   secret: process.env.NEXTAUTH_SECRET, // use the secret key from the environment variable
//   // callbacks: {
