...
export function NavigationEvents({ children }) {
  ...
  useEffect(() => {
    // Track page view on first render only.
  ...
  return (
    <>
      {pathname === "/CallBack" ? (
        ...
        // <Link className=" cursor-pointer" href={"/CallBack"}>
        //   <div className="group xl:block hidden h-32 w-32  fixed z-40 right-8 bottom-8">
        //     <div className="absolute top-0 bottom-0 right-0 left-0">
        //       <div className="test top-0 bottom-0 right-0 left-0 h-32 w-32 text-black group-hover:[animation-play-state:paused]  bg-[url('/images/Req.svg')]"></div>
        //     </div>
        //     <div className=" absolute top-1/2 left-1/2  -translate-x-[50%] -translate-y-[50%]">
        //       <div className="group-hover:animate-bounce h-10 w-10">
        //         <svg
        ...
        //   </div>
        // </Link>
        <div className="fixed hidden bottom-0 end-0 z-[60] sm:max-w-xl w-full mx-auto p-6">
          {/* <!-- Card --> */}
