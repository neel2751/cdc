          ...
          <strong>
            <span style={{ fontSize: "15px" }}>
              <span className="subtitle">
                Last updated
                <b className="question">April 29, 2024</b>
              </span>
            </span>
          </strong>
        </span>
        ...
        <span style={{ color: "rgb(127, 127, 127)" }}>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
            <span className="body_text">
              ...
              (<span className="block-component"></span>'<strong>we</strong>', '
              <strong>us</strong>', or '<strong>our</strong>'
              <span className="else-block"></span>
            </span>
            <span className="body_text">
              ), describes how and why we might collect, store, use, and/or
              share (<span className="block-component"></span>'
              <strong>process</strong>'<span className="else-block"></span>)
              your information when you use our services (
              <span className="block-component"></span>'
              <strong>Services</strong>'<span className="else-block"></span>
              ), such as when you:
            </span>
          </span>
        </span>
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span className="body_text">
                ...
                <span style={{ color: "rgb(0, 58, 250)" }}>
                  <span className="question">https://cdc.construction</span>
                </span>
                <span style={{ fontSize: "15px" }}>
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <span className="body_text">
      ...
      <div>
        ...
        <div style={{ lineHeight: "1.5" }}>
          ...
          <a
            ...
            href="https://app.termly.io/notify/c7ca7431-ab2f-4b66-a68b-0ea86033cacc"
                                          ...
                                          <div style={{ lineHeight: "1.5" }}>
                                            <span style={{ fontSize: "15px" }}>
                                              <span data-custom-class="body_text">
                                                ...
                                                to protect the data they hold on
                                                our behalf and to retain it for
